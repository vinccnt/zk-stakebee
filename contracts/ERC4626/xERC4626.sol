...
import {IxERC4626} from "./IxERC4626.sol";
...
abstract contract xERC4626 is IxERC4626, ERC4626 {
    ...
    constructor(uint32 _rewardsCycleLength) {
        ...
        rewardsCycleEnd =
            (block.timestamp.safeCastTo32() / rewardsCycleLength) *
            rewardsCycleLength;
    }
    ...
    function beforeWithdraw(
        ...
        require(
            ...
            "Insufficient total assets to withdraw"
        );
    ...
    function syncRewards() public virtual {
        ...
        require(
            asset.balanceOf(address(this)) >=
                storedTotalAssets_ + lastRewardAmount_,
            "syncRewards: next reward less than 0"
        );
        uint256 nextRewards = asset.balanceOf(address(this)) -
            storedTotalAssets_ -
            lastRewardAmount_;
